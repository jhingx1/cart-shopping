...
public class AddCartServiceTest {
    ...
    public static void main(String[] args) throws NotEnoughItemsInStockException, ProductNotFoundException{
        Cart persistedCart = new Cart(TEST_CUSTOMER_ID);
        persistedCart.addProduct(TEST_PRODUCT_1,2);
        persistedCart.addProduct(TEST_PRODUCT_2,3);
        //logger.info(String.valueOf(persistedCart));

        System.out.println(persistedCart);
        System.out.println(persistedCart.lineItems().size());
//        Cart cart = addToCartService.addToCart(TEST_CUSTOMER_ID,TEST_PRODUCT_2.id(),3);
